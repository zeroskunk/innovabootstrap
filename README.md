# Linearize
Construct a linear, no-fork, best version of the Innova blockchain. The scripts
...
JSON-RPC server. Running `innovad` or `innova-qt -server` will be sufficient.
...
* `input`: innovad blocks/ directory containing blkNNNNN.dat
